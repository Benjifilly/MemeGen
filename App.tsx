...
// Helper to format numbers: 16.00 -> 16, 16.40 -> 16.4
                      ...
                      <div className="p-6 border-t border-neutral-800 space-y-3 bg-neutral-900/90 backdrop-blur-md md:backdrop-blur-none safe-bottom">
                          ...
                          <div className="flex gap-3">
                              <Button 
                                ...
                                className={`flex-1 py-3 border-neutral-700 text-xs transition-all duration-300 ${copySuccess ? 'bg-emerald-600 text-white border-emerald-500 hover:bg-emerald-700' : 'bg-neutral-800 hover:bg-neutral-700'}`}
                              >
                        ...
                        <div className="pt-4 border-t border-neutral-800 space-y-4 animate-fade-in-up">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div className="space-y-1.5">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <span className="text-xs text-neutral-300 font-mono">{formatValue((activeLayer as MemeText).fontSize)}px</span>
                                ...
                                <div className="space-y-1.5">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <span className="text-xs text-neutral-300 font-mono">{formatValue(((activeLayer as MemeText).rotation * 180) / Math.PI)}°</span>
                            ...
                            <div className="space-y-1.5">
                                <div className="flex justify-between items-center">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <span className="text-xs text-neutral-300 font-mono">{formatValue((activeLayer as MemeText).boxWidth)}px</span>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div className="space-y-1.5">
                                    ...
                                    <div className="text-right">
                                         <span className="text-xs text-neutral-300 font-mono">{formatValue((activeLayer as MemeSticker).width)}px</span>
                                    </div>
                                </div>
                                <div className="space-y-1.5">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <span className="text-xs text-neutral-300 font-mono">{formatValue(((activeLayer as MemeSticker).rotation * 180) / Math.PI)}°</span>
                                            <button onClick={() => updateLayer(activeLayer.id, { rotation: 0 })} className="p-1 hover:text-white text-neutral-600"><RotateCcw className="w-3 h-3"/></button>
                                        </div>
                                    </div>
                            ...
                            <div className="space-y-1.5 pt-2">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                     <div className="flex items-center gap-2 bg-neutral-950 border border-neutral-800 rounded-lg px-2 py-1">
                                         ...
                                         <input type="number" step="0.01" value={formatValue(activeLayer.x)} onChange={(e) => updateLayer(activeLayer.id, { x: parseFloat(e.target.value) })} className="w-full bg-transparent text-xs text-white outline-none text-right" />
                                     </div>
                                     <div className="flex items-center gap-2 bg-neutral-950 border border-neutral-800 rounded-lg px-2 py-1">
                                         <span className="text-[10px] text-neutral-500">Y</span>
                                         <input type="number" step="0.01" value={formatValue(activeLayer.y)} onChange={(e) => updateLayer(activeLayer.id, { y: parseFloat(e.target.value) })} className="w-full bg-transparent text-xs text-white outline-none text-right" />
                                     </div>
                                </div>
                            </div>
                         </div>
